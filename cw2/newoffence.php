...
<h1 style="font-family:fantasy;text-align:center; font-size: 1.5cm;" class="mt-3">Offences</h1>
    <div class="container">
       <form method="post">
<div class="row justify-content-center align-items-center mt-4">
    <div class="col-auto">
        <input type="type" placeholder="Search description" name="search" class="form-control">
        </div>
        <div class="col-auto">
...
<!--searching information code from https://www.youtube.com/watch?v=9ANd4KVPQtE&t=679s&ab_channel=StepbyStep-->
    ...
    if(isset($_POST['submit'])){
       $search=$_POST['search'];
       $sql="Select * from `Offence` where Offence_description like '%$search%' or Offence_maxFine like '%$search%' or Offence_maxPoints like '%$search%'";
...
<!-- Professor's code login: lab-8-demo-code/ineractive-5.php for insert and delete-->
      ...
      <table class="table table-sm table-bordered" style="text-align:center;">
        ...
        $sql = "SELECT * FROM Offence ORDER BY Offence_ID;";
