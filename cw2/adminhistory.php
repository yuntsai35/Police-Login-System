...
<h1 style="font-family:fantasy;text-align:center; font-size: 1.5cm;" class="mt-3">Admin History</h1>
    <div class="container">
       <form method="post">
<div class="row justify-content-center align-items-center mt-4">
    ...
    $search=$_POST['search'];
    $sql="Select * from `history` where username like '%$search%' or database like '%$search%' or action like '%$search%'";
...
?>
      ...
      <?php 
        ...
        $sql = "SELECT * FROM history ORDER BY history_id;";
